...
<div class="row">
    <!-- Profile info -->
    <form action="{{ route('admin.update', $adminById->id) }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field()}}
        {{ method_field('PUT')}}
        <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group pt-15">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"  class="styled checkAll"  {{ (count($adminRoles) == 17 ) ? 'checked' : ' ' }} >
                                        Select All
                                    </label>
                                </div>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox"  value="{{ $role->id }}" name="role_id[]" class="styled"  {{ (in_array($role->id, $adminRoles)) ? 'checked' : ' ' }} >
                                        {{ $role->role_name }}
                                    </label>
                                </div>
                                @endforeach
